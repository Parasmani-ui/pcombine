...
const ProductRevenueSharePie = (props) => {
  ...
  products.forEach((product) => {
    ...
    _values.push(parseInt(product.revenue));
  ...
  return <Card className="center" style={style}>
    <Card.Header>
      ...
      <AutoSaveText
        saveKey="text.product_revenue_share_heading"
        text={caseStudy.text.product_revenue_share_heading || 'Product Revenue Share'}
        {...props}
      />
    </Card.Header>
    <Card.Body>
...
export default ProductRevenueSharePie;
