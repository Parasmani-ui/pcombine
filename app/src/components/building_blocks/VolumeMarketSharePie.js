...
const VolumeMarketSharePie = (props) => {
  ...
  teams.forEach((team) => {
    ...
    _values.push(parseInt(team.unitsSold));
  ...
  <Card className="center">
    <Card.Header>
      ...
      />
      <AutoSaveText 
        saveKey="text.volume_market_share_heading"
        text={caseStudy.text.volume_market_share_heading || 'Volume Market Share'}
        {...props}
      />
    </Card.Header>
    <Card.Body>
...
export default VolumeMarketSharePie;
