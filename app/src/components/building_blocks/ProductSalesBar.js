...
const ProductSalesBar = (props) => {
  ...
  teams.forEach((team) => {
    ...
    products.forEach((product, idx) => {
      sales[idx].push(product.unitsSold);
    });
  ...
  return <Card className="center">
    <Card.Header>
      <AutoSaveText
        saveKey="text.product_sales_bar_heading"
        text={caseStudy.text.product_sales_bar_heading || 'Product Sales'}
        {...props}
      />
    </Card.Header>
    <Card.Body>
...
export default ProductSalesBar;
